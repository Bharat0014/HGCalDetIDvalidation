...
process.HGCalRawValidEE = cms.EDProducer('HGCalRawValidEE',
    infoFileName = cms.string("/eos/user/b/bsirasva/DetIdGeneration/detid_EElayer1.csv"),
)
...
process.p = cms.Path(process.HGCalRawValidEE)
