...
process.HGCalRawValidHEScintillator = cms.EDProducer('HGCalRawValidHEScintillator',
    infoFileName = cms.string("/eos/user/b/bsirasva/DetIdGeneration/detid_HESclayer8.csv"),
)
...
process.p = cms.Path(process.HGCalRawValidHEScintillator)
