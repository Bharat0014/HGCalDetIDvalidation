...
process.HGCalRawValidHESilicon = cms.EDProducer('HGCalRawValidHESilicon',
    infoFileName = cms.string("/eos/user/b/bsirasva/DetIdGeneration/detid_HElayer1.csv"),
)
...
process.p = cms.Path(process.HGCalRawValidHESilicon)
